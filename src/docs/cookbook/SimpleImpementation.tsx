...
export function SimpleImplementation() {
	...
	return (
		<UIShell.Provider
			...
			isHeaderNavigationItemActive={(navigationItem) =>
				navigationItem.href === "/" + currentHref.split("/")[1]
			}
			isSidebarNavigationItemActive={(navigationItem) =>
				navigationItem.href === currentHref
			}
		>
			<UIShell.Grid>
				<UIShell.Header>
